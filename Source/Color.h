...
inline SDL_Color ColorConvert(const color4_t& color4)
{
	...
	color.r = static_cast<Uint8>(std::clamp(color4.r, 0.0f, 1.0f) * 255.0f);
	color.g = static_cast<Uint8>(std::clamp(color4.g, 0.0f, 1.0f) * 255.0f);
	color.b = static_cast<Uint8>(std::clamp(color4.b, 0.0f, 1.0f) * 255.0f);
...
inline SDL_Color ColorConvert(const color3_t& color3)
{
	...
	color.r = static_cast<Uint8>(std::clamp(color3.r, 0.0f, 1.0f) * 255.0f);
	color.g = static_cast<Uint8>(std::clamp(color3.g, 0.0f, 1.0f) * 255.0f);
	color.b = static_cast<Uint8>(std::clamp(color3.b, 0.0f, 1.0f) * 255.0f);
	color.a = 255;
